...
public class MyCarsFragment extends Fragment {
    private SwipeMenuListView mCarList;
    private FirebaseAuth mAuth;
    DatabaseReference databaseCars;
    List<Cars> carsArrayList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mCarList.setSwipeDirection(SwipeMenuListView.DIRECTION_LEFT);
...
// set creator
        mCarList.setMenuCreator(creator);

        mCarList.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                switch (index) {
                    case 0:
                        ...
                        //Toast.makeText(getActivity(), carsArrayList.get(position).getmCarName()+" Should Delete!", Toast.LENGTH_SHORT).show();
                        break;
                }
